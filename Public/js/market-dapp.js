function TncDapp() {
    ...
    this.render = async function(erc1155, id, amount, price, token, address, sellerAddress, swapMode, index, hasMore, which, isBatch, multiplier, category, category_index, shadowed){
        ...
        let explorer = 'https://explorer.harmony.one/token/';
        switch (chain_id) {
            case '1666600000':
    ...
    this.populateNftsView = async function(e){
        ...
        for(let i = 0; i < ask.erc1155Address.length+ask.lenght; i++){
    ...
    this.startAccountCheck = function(){
        ...
        if(window.onewallet){
            ...
            window.onewallet.on('accountsChanged', function(accounts){
                const _that = _this;
    ...
    this.startChainCheck = function(){
        ...
        if(window.onewallet) {
            window.onewallet.on('chainChanged', async function (chain) {
