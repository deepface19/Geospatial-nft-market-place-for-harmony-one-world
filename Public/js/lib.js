...
function TncLib(){
    ...
    // MOONBASE ALPHA
        ...
        this.hrc721 = new web3.one.Contract(hrc721ABI, '', {from: this.account});
        this.hrc1155 = new web3.one.Contract(hrc1155ABI, '', {from: this.account});
        this.genesis = new web3.one.Contract(genesisABI, '', {from: this.account});
        this.farm = new web3.one.Contract(farmABI, '', {from: this.account});
        this.farmShop = new web3.one.Contract(farmShopABI, '', {from: this.account});
        this.multiBatch = new web3.one.Contract(multiBatchABI, '', {from: this.account});
        this.account = '';
        ...
        this.one = new web3.eth.Contract( oneABI, 'null', {from:this.account} );
